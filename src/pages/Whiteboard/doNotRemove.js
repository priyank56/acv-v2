...
window.onload = function () {
  ...
  function drawOnCanvas(stroke) {
    ...
    if (stroke.length >= 3) {
      ...
      context.stroke();
      context.beginPath();
      context.moveTo(xc + 20, yc - 300 * 2);
    } else {
      const point = stroke[l];
      context.lineWidth = point.lineWidth;
      context.strokeStyle = point.color;
      context.beginPath();
      context.moveTo(point.x + 20, point.y - 300 * 2);
      context.stroke();
    }
  }
...
window.onload = function () {
  ...
  canvas.width = window.innerWidth * 2 - 28;
  canvas.height = window.innerHeight * 2;
  ...
  function drawOnCanvas(stroke) {
    ...
    if (stroke.length >= 3) {
      ...
      context.stroke();
      context.beginPath();
      context.moveTo(xc, yc - 60 * 2);
    } else {
      const point = stroke[l];
      context.lineWidth = point.lineWidth;
      context.strokeStyle = point.color;
      context.beginPath();
      context.moveTo(point.x, point.y - 60 * 2);
      context.stroke();
    }
  }
